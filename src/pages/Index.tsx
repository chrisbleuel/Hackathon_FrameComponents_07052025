...
export default function Index() {
  ...
  return <div className="bg-white">
      ...
      <main className="bg-white w-full">
        <div className="items-stretch flex w-full gap-[40px_113px] flex-wrap py-8 px-[24px]">
          <aside className="bg-[#f5f8fa] rounded-md">
            <ProductGallery images={productImages} />
            <div className="flex w-full bg-[F5F8FA] bg-[#f5f8fa] px-0">
            ...
            <div className="w-full bg-[F5F8FA] px-0 py-[32px] bg-[#000a00]/0">
