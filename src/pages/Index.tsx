...
const productImages = [
  { src: 'https://cdn.builder.io/api/v1/image/assets/473d424b1c61442992c0c3820764778e/06914a8959f93f06997f705735e8b326e13a1555?placeholderIfAbsent=true', alt: 'Product front view' },
  { src: 'https://cdn.builder.io/api/v1/image/assets/473d424b1c61442992c0c3820764778e/0c0c460bb5d451440f1ba10fb2f7e7454137ace4?placeholderIfAbsent=true', alt: 'Product side view' },
];

const colorOptions = [
  { id: 'black', name: 'Black', color: '#000000' },
  { id: 'gold', name: 'Gold', color: 'rgb(209,187,177)' },
  { id: 'grey', name: 'Grey', color: 'rgb(124,122,121)' },
  { id: 'blue', name: 'Blue', color: 'rgb(53,77,255)' },
];
...
const benefits = [
  {
    ...
    link: { text: 'Warranty details', url: '#' },
  },
  {
    ...
    title: 'Free shipping',
    link: { text: 'More about shipping', url: '#' },
  },
  {
    ...
    link: { text: 'Explore local partners', url: '#' },
  },
  {
    ...
    title: 'Free returns',
    link: { text: 'See return policy', url: '#' },
  },
  {
